...
> Note: These scripts, as implied by the title above and the folder this README is in, require the program [c-script(C)](https://github.com/ryanmjacobs/c/#C).  
